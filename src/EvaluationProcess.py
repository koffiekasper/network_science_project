...
class MetricEvaluation:
    ...
    def run(self, partition_filename):
        ...
        communitiesOUT = create_communities(f'./output/{partition_filename}')
        ...
        data = {
            ...
            "modularity": [modularityOUT, modularityGT]
        }
        
        pd.DataFrame(data).to_csv(f"./output_metrics/{partition_filename}.csv".replace("/output/", ""))
