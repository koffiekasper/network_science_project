...
docker run project python ./src/dpclus.py $file > ./output/$1_dpclus_no_weights.txt
docker run project python ./src/dpclus_weighted.py $file > ./output/$1_dpclus_weighted.txt

docker run project python ./src/graph_entropy.py $file > ./output/$1_graph_entropy.txt
docker run project python ./src/graph_entropy_weighted.py $file > ./output/$1_graph_entropy_weighted.txt

docker run project python ./src/ipca.py $file > ./output/$1_ipca.txt
